(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const e={allQuestions:[],questions:[],started:!1,finished:!1,currentIndex:0,selectedAnswers:[],submitted:!1,score:0,correctCount:0,wrongCount:0,loading:!0,error:"",selectedCategories:[],returningHome:!1,filterExpanded:!0,wrongQuestionIds:[],playMode:"all",questionLimit:20},m=document.querySelector("#app"),A="quiz_wrong_questions";function _(t){return t.filter(n=>{const s=typeof n.question=="string"&&n.question.trim(),r=Array.isArray(n.options)&&n.options.length>1,o=Array.isArray(n.answer)&&n.answer.length>0;return s&&r&&o}).map(n=>({...n,id:String(n.id),question:n.question.trim(),options:n.options.map(s=>String(s).trim()),answer:n.answer.map(s=>Number(s)).sort((s,r)=>s-r),answer_type:n.answer_type||(n.answer.length>1?"複選":"單選")}))}function $(){return e.questions[e.currentIndex]}function z(){const t=new Set;return e.allQuestions.forEach(n=>{t.add(n.type||"未分類")}),[...t]}function x(){const t=e.selectedCategories.length===0?[...e.allQuestions]:e.allQuestions.filter(s=>e.selectedCategories.includes(s.type||"未分類"));if(e.playMode!=="wrong")return t;if(e.wrongQuestionIds.length===0)return[];const n=new Set(e.wrongQuestionIds);return t.filter(s=>n.has(s.id))}function W(t){return[...t].map(n=>({question:n,random:Math.random()})).sort((n,s)=>n.random-s.random).map(n=>n.question)}function y(t){if(t<=0)return[];if(t<=5)return[t];const n=[];for(let s=5;s<t;s+=5)n.push(s);return n[n.length-1]!==t&&n.push(t),n}function j(t){return e.questionLimit==="all"?t:Math.min(e.questionLimit,t)}function I(t){const n=y(t);return n.length===0?0:e.questionLimit==="all"?n[n.length-1]:n.includes(e.questionLimit)?e.questionLimit:n.find(s=>s>=e.questionLimit)??n[n.length-1]}function G(){e.currentIndex=0,e.selectedAnswers=[],e.submitted=!1,e.finished=!1,e.started=!1,e.score=0,e.correctCount=0,e.wrongCount=0}function f(){return{windowY:window.scrollY,panelScrollTop:document.querySelector(".filter-list")instanceof HTMLElement?document.querySelector(".filter-list").scrollTop:0}}function p(t){if(!t)return;window.scrollTo({top:t.windowY});const n=document.querySelector(".filter-list");n instanceof HTMLElement&&(n.scrollTop=t.panelScrollTop)}function g(){e.questions=x(),G()}function P(t){if(t==="全部"){e.selectedCategories=[],g();return}e.selectedCategories=e.selectedCategories.includes(t)?e.selectedCategories.filter(n=>n!==t):[...e.selectedCategories,t],g()}function k(){e.selectedCategories=[],g()}function R(){try{const t=window.localStorage.getItem(A);if(!t)return[];const n=JSON.parse(t);return Array.isArray(n)?n.map(s=>String(s)):[]}catch{return[]}}function q(){window.localStorage.setItem(A,JSON.stringify(e.wrongQuestionIds))}function Y(t){e.wrongQuestionIds.includes(t)||(e.wrongQuestionIds=[...e.wrongQuestionIds,t],q())}function F(t){e.wrongQuestionIds.includes(t)&&(e.wrongQuestionIds=e.wrongQuestionIds.filter(n=>n!==t),q())}function J(){e.wrongQuestionIds=[],q(),e.playMode==="wrong"&&g()}function Q(t){e.playMode=t,g()}function S(t){const n=e.questions.length,s=y(n);if(s.length===0)return;const r=I(n),o=Math.max(s.indexOf(r),0),i=t==="increase"?Math.min(o+1,s.length-1):Math.max(o-1,0);e.questionLimit=s[i]}function K(){return e.selectedCategories.length===0?"全部":e.selectedCategories.length===1?e.selectedCategories[0]:`已選 ${e.selectedCategories.length} 類`}function B(){return e.playMode==="wrong"?"歷史錯題":"全部題庫"}function M(t){return t.answer_type==="複選"||t.answer.length>1}function V(t){const n=$();e.submitted||(M(n)?e.selectedAnswers=e.selectedAnswers.includes(t)?e.selectedAnswers.filter(s=>s!==t):[...e.selectedAnswers,t].sort((s,r)=>s-r):e.selectedAnswers=[t],a())}function D(t,n){return t.length!==n.length?!1:t.every((s,r)=>s===n[r])}function U(){if(e.submitted||e.selectedAnswers.length===0)return;const t=$(),n=[...e.selectedAnswers].sort((r,o)=>r-o),s=D(n,t.answer);e.submitted=!0,s?(e.score+=10,e.correctCount+=1,F(t.id)):(e.wrongCount+=1,Y(t.id)),a()}function X(){if(e.currentIndex>=e.questions.length-1){e.finished=!0,a();return}e.currentIndex+=1,e.selectedAnswers=[],e.submitted=!1,a()}function w(){const t=x(),n=W(t).slice(0,j(t.length));n.length!==0&&(e.questions=n,e.started=!0,e.finished=!1,e.currentIndex=0,e.selectedAnswers=[],e.submitted=!1,e.score=0,e.correctCount=0,e.wrongCount=0,a())}function Z(){w()}function ee(){e.returningHome||(e.returningHome=!0,a(),window.setTimeout(()=>{e.returningHome=!1,e.started=!1,e.finished=!1,e.currentIndex=0,e.selectedAnswers=[],e.submitted=!1,e.score=0,e.correctCount=0,e.wrongCount=0,a()},420))}function l(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function te(t,n){return t<=0?"目前沒有可作答題目":n<e.questionLimit?`此分類上限 ${n} 題`:`目前設定 ${n} 題`}function ne(){const t=e.questions.length,n=e.wrongQuestionIds.length,s=I(t),r=y(t),o=r.length===0||s===r[0],i=r.length===0||s===r[r.length-1],c=`
    ...
    <main class="shell">
      <section class="hero-card">
        ...
        <div class="hero-actions">
          ...
          <button class="btn btn-secondary" data-action="shuffle" ${e.loading||t===0?"disabled":""}>重新抽選</button>
        </div>
        <p class="status-text">
  ...
  `}function se(){const t=e.questions.length,n=e.wrongQuestionIds.length,s=t===0?0:Math.round(e.correctCount/(e.correctCount+e.wrongCount||1)*100);m.innerHTML=`
  ...
  `}function oe(){const t=$(),n=e.currentIndex+1,s=e.questions.length,r=t.answer,o=M(t),i=t.options.map((b,d)=>{const u=b.split(`
`).map(h=>h.trim()).filter(Boolean),L=u.length>1?"option-text bilingual":"option-text",C=e.selectedAnswers.includes(d),v=r.includes(d),H=e.submitted&&v,E=e.submitted&&C&&!v,T=H?"is-correct":E?"is-wrong":C?"is-selected":"",O=d+1;return`
